...
def test_i18n_runtime_is_wired_with_persistent_chinese_default():
    ...
    assert '<script src="/static/i18n.js?v=brief-253-chat-artifacts-3"></script>' in index
    assert '<script src="/static/js/core.js?v=brief-253-chat-artifacts-3"></script>' in index
    assert '<script src="/static/js/dream-settings.js?v=brief-223-rpg-dream-admin-2"></script>' in index
    assert "ADMIN_UI_FRAGMENT_VERSION = 'brief-253-chat-artifacts-3'" in core_js
    assert '<script src="/static/js/observability.js?v=brief-253-chat-artifacts-3"></script>' in index
