...
def test_memory_event_query_page_is_registered_and_cache_busted():
    ...
    assert "ADMIN_UI_FRAGMENT_VERSION = 'brief-252-rpg-kp-routing-1'" in core
...
def test_shadow_recall_rollout_controls_are_registered_and_cache_busted():
    ...
    assert "ADMIN_UI_FRAGMENT_VERSION = 'brief-252-rpg-kp-routing-1'" in core
    assert '<script src="/static/js/settings.js?v=brief-252-rpg-kp-routing-1"></script>' in index
