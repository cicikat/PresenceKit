...
|---|---|---|---|
| WS | `/ws/desktop` | desktop | Emerald-client 桌宠 |
| WS | `/ws/device` | device | presence-device 固件 |
| POST | `/desktop/chat`、`/desktop/activate`、`/desktop/wake` | desktop | Emerald-client |
...
| GET/POST/PATCH | `/dream/*` | dream | Emerald-client 梦境界面 |
| GET/POST | `/sensor/*`、`/watch/*` | sensor | Emerald-mobile、桌宠 |
| GET/POST | `/activity/*`（reading/gomoku/chess/dream_seed） | activity | Emerald-client 活动界面 |
| GET/POST | `/coplay/*` | coplay | Emerald-client 陪玩控制 |
