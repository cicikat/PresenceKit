...
不在裁剪表里（无 `_drop_priority`）：`6a_user_identity`、`5_profile`、`5_profile_pref`、`5.1_user_facts`、`9_history`、`11_author_note`、`11.5_post_history`、`10.5_action_trace`（够小且时效性强，不参与裁剪）等核心层。
