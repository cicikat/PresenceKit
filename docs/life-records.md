...
2026-09-13：角色可读开启后，最近就绪记录会随原 owner 对话/主动机会提供，成功评估才记为已读。
read_life_records 先返回有界索引，可用 record_id + offset 分页读用户内容和已有描述。
GET /settings/life-records 增加无正文 continuity 观测；管理面显示待评估状态。
版本更正、撤回、权限与保留限制详见 [资料接续](media-continuity-2026-09-13.md)。
