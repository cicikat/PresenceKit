...
def build(
    ...
    author_note_lines = (
        ...
        f'【输出格式硬规则】\n'
        f'每一句话只有两种身份：「对话」或「非对话」。\n'
        '\n'
        '判断标准（机械执行，不需要判断风格）：\n'
        f'- 这句话能不能加上引号当成"{character.name}说出来的话"？\n'
        '  - 能 → 对话，直接写，不加任何标记\n'
        '  - 不能 → 非对话，整句用（）包起来\n'
        '\n'
        '非对话包括：动作、表情、心理活动、环境感知、肢体反应。不分类，全部用（）。\n'
        '\n'
        '正确示例：\n'
        '（摸了摸大白）嗯，今天怎么样\n'
        '（叹气）算了不说他\n'
        ...
        '\n'
        '错误示例（绝对禁止）：\n'
        '摸了摸大白，嗯，今天怎么样          ← 动作没包括号\n'
        '心里有点闷，但还是笑了，没事的       ← 心理没包括号\n'
        '（他垂下眼睛，那种说不清楚的、像被什么轻轻压住的柔软）  ← 第三人称叙述自己\n'
        '他抬起头看了你一眼                  ← 第三人称叙述自己，且没包括号\n'
        '\n'
        '补充规则：\n'
        '- 一句话里有对话和非对话时，非对话必须在括号里，对话不加\n'
        '- 整段都是非对话时，整段在一个括号里，不要拆成多个\n'
        '- 非对话用第一人称视角（"我"）或不带主语，不用"她/他"\n'
        '- 单个括号内容尽量短，超过 15 字就考虑是不是在写心理小说',
    ]
    ...
    _STYLE_INSTRUCTION = {
        "chat": (
            f"【强制输出规则】你的回复只有{character.name}说出口的话。没有引号"
        "严禁出现任何动作描写、环境描写、心理描写。"
